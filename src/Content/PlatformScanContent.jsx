                ...
                return <table className="table" style={{fontSize: `30px`,width: `100%`}}>
                    ...
                    <tr>
                        <td colSpan="100%" style={{alignSelf: `center`}}><h3
                            style={{textAlign: `center`,  fontSize: `48px`}}>{`Пирамида №${this.state.platformName}`}</h3></td>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
            ...
            return (
                <div style={{width: `100%`}}>
                    <table className="table">
                        ...
                        <tr>
                            <td colSpan="100%" style={{alignSelf: `center`}}><h3
                                style={{textAlign: `center` , fontSize: `24px`}}>{`Пирамида №${this.state.platformName}`}</h3></td>
                        </tr>
